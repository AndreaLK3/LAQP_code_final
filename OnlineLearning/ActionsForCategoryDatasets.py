...
def get_actionsforcategories():
    return [a1_title_desc_categs("a1_title_desc_categs"), a2_desc_keywords("a2_desc_keywords"),
...
class a1_title_desc_categs(A.Action):
    ...
    def execute_action(self, x):
        ...
        #logging.info("Action %s, votes: %s", self.name,
        #             [self.Pdesc_Qtext_vote, self.Ptitle_Qtext_vote, self.Pcategories_Qtext_vote])

        votes_result = w* self.Pdesc_Qtext_vote + w*self.Ptitle_Qtext_vote + w*self.Pcategories_Qtext_vote
        return int(round(votes_result))



class a2_desc_keywords(A.Action):
    def __init__(self, name):
        self.name = name
        self.Pdesc_Qtext = A.Compare2SingleVectors(p_featurename="p_descvec", cosine_sim_fraction=0.6,name="")
        self.Pkeywords_Qtext = A.CompareListToVector(p_featurename="p_kwsVectors", cosine_sim_fraction=0.55,name="")
        self.Pkeywords_Qkeywords = A.Compare2Lists(p_featurename="p_kwsVectors", cosine_sim_fraction=0.55,name="")
        self.Pcategories_Qkeywords = A.Compare2Lists(p_featurename="p_mdcategories", cosine_sim_fraction=0.55,name="")
    ...
    def execute_action(self, x):
        ...
        votes = [self.Pdesc_Qtext_vote, self.Pkeywords_Qtext_vote, self.Pkeywords_Qkeywords_vote, self.Pcategories_Qkeywords_vote]
        if 1 in votes:
            logging.info("Action %s, votes: %s", self.name,votes)


        votes_result = 0.2* self.Pdesc_Qtext_vote + 0.3*self.Pkeywords_Qtext_vote \
...
class a3(A.Action):
    def __init__(self, name):
        self.name = name
        self.Pdesc_Qtext = A.Compare2SingleVectors(p_featurename="p_descvec", cosine_sim_fraction=0.8,name="")
        self.Ptitle_Qtext = A.Compare2SingleVectors(p_featurename="p_titlevec", cosine_sim_fraction=0.9,name="")
    ...
    def execute_action(self, x):
        ...
        votes_result = votes_w * self.Pdesc_Qtext_vote + votes_w * self.Ptitle_Qtext_vote + \
                       votes_w * self.Pcategories_Qtext_vote + votes_w * self.Pkeywords_Qtext_vote
        return int(round(votes_result))
